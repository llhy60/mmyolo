...
'''
 Usage: python tools/dataset_converters/voc2coco.py --devkit_path /home/data/VOCdevkit2007 --out-dir /home/data --out-format coco
'''

# 根据自己的数据类别修改下面classes列表
voc_classes = ['electric_scooter', 'person', 'bicycle', 'others']
...
def cvt_annotations(devkit_path, years, split, out_file):
    ...
    for year in years:
        ...
        if not osp.isfile(filelist):
            ...
            return
        img_names = mmengine.list_from_file(filelist)
        xml_paths = [
        ...
        part_annotations = mmengine.track_progress(parse_xml,
